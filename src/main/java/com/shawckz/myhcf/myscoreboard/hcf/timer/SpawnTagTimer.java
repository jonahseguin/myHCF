...
public class SpawnTagTimer extends HCFTimerLabel {

    private final TimerUpdater timerUpdater;

    private static final DecimalFormat FORMAT = new DecimalFormat("#.#");

    public SpawnTagTimer(HCFScoreboardWrapper scoreboard, int score, double timerValue, TimerUpdater timerUpdater) {
