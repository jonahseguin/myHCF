...
public class PvPTimer extends HCFTimerLabel {

    private final TimerUpdater timerUpdater;

    private static final DecimalFormat FORMAT = new DecimalFormat("#.#");

    public PvPTimer(HCFScoreboardWrapper scoreboard, int score, double timerValue, TimerUpdater timerUpdater) {
    ...
    public LabelProvider<HCFTimerLabel> getLabelProvider() {
        return label -> HCFLabelID.PVP_TIMER.key + FORMAT.format(label.getTimerValue());
    }
